...
public class ProjectDBSchema {
    ...
    public static final class SprintsTable {
    ...
    public static final class MiniTasksTable {
        public static final String NAME = "mini_tasks";

        public static final class Cols {
            public static final String TASK_ID = "task_id";
            public static final String MINI_TASK_ID = "mini_task_id";
            public static final String STORY = "story";
            public static final String KANBAN_FLAG = "kanban_flag";
        }
    }
}
